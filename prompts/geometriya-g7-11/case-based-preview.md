...
4. Checkpoint 2        — Decide: which formula/property to use?
5. Learning Block 2    — short explanation showing the method/relationship to apply
6. Checkpoint 3        — Justify or Avoid Mistake: why does the alternative formula fail?
...
8. Final simulation    — correct calculation + wrong calculation + why wrong fails
9. Feedback summary
10. Completion rules
```
