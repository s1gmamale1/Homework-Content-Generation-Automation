...
4. Checkpoint 2        — Decide: which law/formula applies?
5. Learning Block 2    — short explanation showing the method/relationship to apply
6. Checkpoint 3        — Justify or Avoid Mistake: predict effect or rule out incorrect formula
...
8. Final simulation    — correct result + wrong result + why wrong result is impossible
9. Feedback summary
10. Completion rules
```
