...
| 4 | **Connect the EXISTING image-generation project** (already built as a separate big project — clarified 2026-07-03) to this pipeline; NOT a from-zero build. Natural seam: our described placeholders (`![visual: …](placeholder)`) as its prompts. Work out: its interface, cost/image, insertion point, Notion rendering. | integration plan | WISHLIST `homework-images-1` |
