...
export const FLOW_V2_PHASES: FlowV2PhaseDef[] = [
  {
    key: "cbp",
    column: "cbp_json",
    title: "Case-Based Preview",
    division: "Learning Sections",
    isEmpty: (d) => !d,
    render: (d: CaseBasedPreview) => <CaseBasedPreviewView cbp={d} />,
  },
  {
    key: "flashcards",
    column: "flashcards_json",
    title: "Flashcards",
    division: "Learning Sections",
    isEmpty: emptyArr("cards"),
    render: (d: FlashcardsPack) => <FlashcardDeck cards={d.cards ?? []} />,
  },
  {
    key: "memory-check",
    column: "memory_check_json",
    title: "Memory Check",
    division: "Learning Sections",
    isEmpty: emptyArr("items"),
    render: (d: MemoryCheckPack) => <MemoryCheckView pack={d} />,
  },
  {
    key: "practice-rlc",
    column: "practice_rlc_json",
    title: "Real-Life Challenge",
    division: "Practice Arc",
    isEmpty: (d) => !d,
    render: (d: RealLifeChallenge) => <RealLifeChallengeView rlc={d} />,
  },
  {
    key: "practice-error-detection",
    column: "practice_error_detection_json",
    title: "Error Detection",
    division: "Practice Arc",
    isEmpty: (d) => !d,
    render: (d: ErrorDetection) => <ErrorDetectionView ed={d} />,
  },
  ...
  {
    key: "boss-arena",
    column: "boss_arena_json",
    title: "Boss Arena",
    division: "Boss Arena",
    isEmpty: emptyArr("questions"),
    render: (d: BossArena) => <BossArenaView boss={d} />,
  },
];
