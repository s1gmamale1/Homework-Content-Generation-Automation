...
_NOTATION_EXACT = (
    ...
    "steps instead.\n"
    "- A system of equations takes a SINGLE left brace over its equations. "
    "Displayed on its own: stack the equations, one per line, each line "
    "starting with \"{ \". Written INLINE in a sentence: ONE left brace with "
    "a semicolon separator — { 2x + y = 11 ; 3x − 2y = 6. NEVER open a "
    "second brace and NEVER join the equations with \"va\"/\"и\"/\"and\" — "
    "the form \"{ … va { …\" is banned.\n"
