...
_CBP_SCIENCES = (
    ...
    "change, level (cell/organ/organism/population) unnamed; level → "
    "structure → function → prediction; never a formula biology does not have; "
    "distractors hold the structure, vary the level; DPE: the level asked · the "
    "mechanism there · its failure at another level. Other sciences: whichever "
    "frame fits, or the general framing.\n\n"
...
_CBP_HUMANITIES = (
    ...
    "maker, date, primary/secondary; distractors hold the event, vary the source. "
    "Plant exactly one true but irrelevant fact, named in "
    "feedback as the planted distractor; DPE: who made the source and "
    "why · what it can and cannot answer · which true fact was set aside.\n\n"
