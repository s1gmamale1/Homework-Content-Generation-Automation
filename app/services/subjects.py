...
_DEFS: list[SubjectDef] = [
    ...
    _d("english", "English", "languages", _SENTENCE, "english", "ingliz", ru=("нгл",)),
    ...
    _d("oqish-savodxonligi", "Reading literacy (O'qish savodxonligi)", "languages",
       _SENTENCE, "uz", "oqish savodxonligi", "oqish", ru=("чтение",)),
    ...
    _d("tabiiy-fanlar", "Natural sciences (Tabiiy fanlar)", "sciences", _TICTACTOE,
       "uz", "tabiiy fanlar", "tabiatshunoslik", "tabiiy", "science", ru=("естествознание",)),
    ...
    _d("informatika", "Informatics (Informatika)", "default", _MEMORY, "uz",
       "informatika", "dasturlash", "robototexnika", ru=("информатика",)),
    _d("atrof-muhit", "Environmental studies (Atrof-muhit)", "sciences", _TICTACTOE,
       "uz", "atrof-muhit", "atrof muhit"),
    _d("huquq", "Law (Huquq)", "humanities", _MEMORY, "uz", "huquq", ru=("право",)),
    _d("iqtisodiyot", "Economics (Iqtisodiyot)", "humanities", _MEMORY, "uz",
       "iqtisodiy bilim", "iqtisodiyot", "tadbirkorlik", ru=("экономика",)),
    ...
    _d("musiqa", "Music (Musiqa)", "default", _MEMORY, "uz", "musiqa", ru=("музыка",)),
    _d("tasviriy-sanat", "Fine arts (Tasviriy san'at)", "default", _MEMORY, "uz", "tasviriy", ru=("изо",)),
    _d("texnologiya", "Technology (Texnologiya)", "default", _MEMORY, "uz", "texnologiya", ru=("технология",)),
    _d("tarbiya", "Upbringing (Tarbiya)", "humanities", _MEMORY, "uz", "tarbiya", ru=("воспитание",)),
    _d("chqbt", "Pre-conscription training (CHQBT)", "humanities", _MEMORY, "uz", "chqbt", ru=("нвп",)),
]
